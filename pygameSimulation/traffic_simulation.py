...
# Drastically reduced speeds configuration (36% of original speed)
speeds = {
    'car': 0.81,    # Original: 2.25 → 2.25 * 0.36 = 0.81
    'bus': 0.648,   # Original: 1.8 → 1.8 * 0.36 = 0.648
    'truck': 0.648, # Original: 1.8 → 1.8 * 0.36 = 0.648
    'rickshaw': 0.72, # Original: 2 → 2 * 0.36 = 0.72
    'bike': 0.9     # Original: 2.5 → 2.5 * 0.36 = 0.9
}

# Coordinates of start
x = {'right':[0,0,0], 'down':[830,782,752], 'left':[1400,1400,1400], 'up':[602,627,657]}    
y = {'right': [328, 350, 378], 'down':[0,0,0], 'left':[498,466,436], 'up':[800,800,800]}
...
signalCoods = [(480,230),(950,230),(950,540),(480,540)]
signalTimerCoods = [(530,210),(900,210),(900,550),(530,550)]
vehicleCountCoods = [(430,240),(1020,240),(1020,550),(430,550)]
vehicleCountTexts = ["0", "0", "0", "0"]

# Coordinates of stop lines
# Adjusted stop line coordinates
stopLines = {
    'right': 420,  # Pushed back for right side
    'down': 270,        # Changed from 600 (move stop line up 50 pixels)
    'left': 1020,   # Pushed back for left side
    'up': 585      # Pushed back for top side
}

# Adjusted default stop positions
defaultStop = {
    'right': 410,  # Adjusted for right
    'down': 250,     # Changed from 320 (match new stop line position)
    'left': 1030,   # Adjusted for left
    'up': 595      # Adjusted for top
}
...
mid = {
    'right': {'x':745, 'y':405},
    'down': {'x':750, 'y':430},  # x increased by 25px (725→750)
    'left': {'x':695, 'y':425},
    'up': {'x':695, 'y':400}
}
rotationAngle = 3
